 ...
 * @author werun
 * @version 1.0
 * @date 2026/07/21 19:29
 * @description
 **/
@DataJdbcTest // 标识这是一个关注Spring Data JDBC组件的测试类  该注解会让每个测试在事务中运行,并在方法结束后回滚事务,从而保证数据库的整洁.
@Import(DataConfig.class) // 导入数据配置,需要启用审计功能
...
public class BookRepositoryJdbcTests {
    ...
    @Autowired
    private JdbcAggregateTemplate jdbcAggregateTemplate; // 用于和数据库交互的低层级对象
